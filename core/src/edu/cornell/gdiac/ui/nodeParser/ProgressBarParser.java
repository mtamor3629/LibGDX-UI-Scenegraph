...
public class ProgressBarParser implements NodeParser{
    ...
    public class ProgressBar2D extends ProgressBar{
        ...
        are not allowed, so I set vertical to false.*/
        ...
        public ProgressBar2D (float min, float max, float stepSize, Skin skin, String styleName){
            super(min,max,stepSize,false,skin,styleName);
        }
        public ProgressBar2D (float min, float max, float stepSize, ProgressBarStyle style){
